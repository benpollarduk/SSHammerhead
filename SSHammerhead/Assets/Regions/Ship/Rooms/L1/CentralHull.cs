...
namespace SSHammerhead.Assets.Regions.Ship.Rooms.L1
{
    internal class CentralHull : IAssetTemplate<Room>
    {
        ...
        public Room Instantiate()
        {
            ...
            return new Room(Name, Description, Introduction, [new Exit(Direction.North), new Exit(Direction.South, true), new Exit(Direction.West), new Exit(Direction.East, true), new Exit(Direction.Down)], items: [new Radio().Instantiate()], enterCallback: enter);
        }
