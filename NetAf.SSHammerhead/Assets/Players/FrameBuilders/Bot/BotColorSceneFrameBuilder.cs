...
namespace NetAF.SSHammerhead.Assets.Players.FrameBuilders.Bot
{
    ...
    /// </summary>
    public sealed class BotColorSceneFrameBuilder : ISceneFrameBuilder
    {
        #region Fields
        ...
        /// </summary>
        public AnsiColor TextColor { get; set; } = MaintenanceBot.DisplayColor;

        /// <summary>
        /// Get or set the input color.
        /// </summary>
        public AnsiColor InputColor { get; set; } = MaintenanceBot.DisplayColor;

        /// <summary>
        /// Get or set the commands color.
        /// </summary>
        public AnsiColor CommandsColor { get; set; } = MaintenanceBot.DisplayColor;
        ...
        /// <summary>
        /// Initializes a new instance of the BotColorSceneFrameBuilder class.
        /// </summary>
        /// <param name="gridStringBuilder">A builder to use for the string layout.</param>
        /// <param name="roomMapBuilder">A builder to use for room maps.</param>
        public BotColorSceneFrameBuilder(GridStringBuilder gridStringBuilder, IRoomMapBuilder roomMapBuilder)
        {
        ...
        public IFrame Build(Room room, ViewPoint viewPoint, PlayableCharacter player, string message, CommandHelp[] contextualCommands, KeyType keyType, int width, int height)
        {
            ...
            else
            {
                ...
                roomMapBuilder?.BuildRoomMap(gridStringBuilder, room, viewPoint, keyType, leftMargin, lastY, out _, out lastY);
